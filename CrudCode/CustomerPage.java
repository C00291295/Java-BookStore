...
public class CustomerPage extends javax.swing.JFrame {
    ...
    public void AddCustomer()
    {
     ...
     try 
     {
        String query = "INSERT INTO customer (first_name, last_name, email, phone_number, address) VALUE ('"+FirstName+"','"+LastName+"','"+Email+"','"+Phone+"','"+Address+"')";
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "customer ID", "First Name", "Last Name", "Email", "Phone Number", "Address"
            }
        ) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        CustomerEditPage GoCustomerEditPage = new CustomerEditPage();
        GoCustomerEditPage.setVisible(true);
        this.setVisible(false);
