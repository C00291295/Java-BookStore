...
public class PublisherPage extends javax.swing.JFrame {
    ...
    public PublisherPage() {
        ...
        Object columns[] = {"publisher_id", "publisher_name", "contact_person", "email", "phone_number", "address"};
    ...
    public void AddPublisher()
    {
     ...
     try 
     {
        String query = "INSERT INTO publisher (publisher_name, contact_person, 	email, phone_number , address) VALUE ('"+PublisherName+"','"+ContactPerson+"','"+PublisherEmail+"','"+PublisherPhone+"','"+PublisherAddress+"')";
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Publisher ID", "Publisher Name", "Contact Person", "Email", "Phone Number", "Address"
            }
        ) {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        PublisherEditPage GoPublisherEditPage = new PublisherEditPage();
        GoPublisherEditPage.setVisible(true);
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PublisherPage().setVisible(true);
            }
        });
    }
